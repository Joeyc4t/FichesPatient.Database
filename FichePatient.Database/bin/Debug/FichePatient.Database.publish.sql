...
CREATE TABLE [dbo].[ETAT_SANTE] (
    ...
    [HYPERKERATOSES_COR_PERI-UNGUEAL]               BIT  NOT NULL,
    [HYPERKERATOSES_COR_PERI-UNGUEAL_DESC]          TEXT NULL,
    [HYPERKERATOSES_COR_SOUS-UNGUEAL]               BIT  NOT NULL,
    [HYPERKERATOSES_COR_SOUS-UNGUEAL_DESC]          TEXT NULL,
